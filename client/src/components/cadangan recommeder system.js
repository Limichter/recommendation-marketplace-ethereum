function recommender(ratings, user) {
    ...
    for (let row of ratings) {
      ...
      const i = row[1];
      const rating = row[2];
      originalMatrix[i] = originalMatrix[i] || [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null];
