			...
			<nav className="navbar navbar-expand-lg navbar-light shadow">
				...
				<div className="collapse navbar-collapse" id="navbarSupportedContent">
					<ul className="navbar-nav mr-auto">
						<li className={this.props.active === 'rating' ? 'nav-item active' : 'nav-item'}>
							<Link className="nav-link" to="/rating">Rating</Link>
						</li>
						<li className={this.props.active === 'all' ? 'nav-item active' : 'nav-item'}>
							<Link className="nav-link" to="/all">All</Link>
						</li>
						<li className={this.props.active === 'list' ? 'nav-item active' : 'nav-item'}>
							<Link className="nav-link" to="/list">List</Link>
						</li>
						<li className={this.props.active === 'recommend' ? 'nav-item active' : 'nav-item'}>
